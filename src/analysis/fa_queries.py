...
def get_top_first_ascensionists(
        conn, user_id=None, year_start=None, year_end=None):
    f"""
...
def get_all_top_first_ascensionists(
        conn, user_id=None, year_start=None, year_end=None):
    query = f"""
    SELECT fa_name, COUNT(*) as fa_count
    FROM analysis.fa
...
def get_first_ascensionist_by_decade(
        conn, name, user_id=None, year_start=None, year_end=None):
    """
...
def get_first_ascensionist_areas(
        conn, name, user_id=None, year_start=None, year_end=None):
    """
...
def get_first_ascensionist_grades(
        conn, name, user_id=None, year_start=None, year_end=None):
    """
...
def get_collaborative_ascensionists(
        conn, name, user_id=None, year_start=None, year_end=None):
    """
...
def get_partnership_routes(conn, fa_name, partner_name,
                           user_id, year_start=None, year_end=None):
    """
